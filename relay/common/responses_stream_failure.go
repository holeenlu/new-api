...
// SetResponsesStreamPreflightFailureEvent preserves a valid upstream terminal
// failure event until the retry loop has exhausted eligible OAuth credentials.
// It is never used after any downstream event has been written.
