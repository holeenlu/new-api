...
type RetryParam struct {
	...
	totalAttempts   int
	resetNextTry    bool
	oauth           *subscriptionOAuthTracker
}
...
func CacheGetRandomSatisfiedChannel(param *RetryParam) (*model.Channel, string, error) {
	...
	if param.TokenGroup == "auto" {
		...
		for i := startGroupIndex; i < len(autoGroups); i++ {
			...
			channel, _ = model.GetRandomSatisfiedChannel(autoGroup, param.ModelName, priorityRetry, param.RequestPath, param.CandidateFilter)
			if channel == nil {
		...
		channel, err = model.GetRandomSatisfiedChannel(param.TokenGroup, param.ModelName, param.GetRetry(), param.RequestPath, param.CandidateFilter)
		if err != nil {
