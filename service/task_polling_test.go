...
func TestUpdateSunoTasksStalePollsRefundExactlyOnce(t *testing.T) {
	...
	seedReservedToken(t, tokenID, userID, "sk-suno-refund-once", initialTokenQuota, taskQuota)
...
func TestRunTaskPollingOnceDoesNotRefundHistoricalFailedTask(t *testing.T) {
	...
	task.Progress = "100%"
	// Use the explicit rollout boundary so this regression remains historical
	// even as the test clock advances.
