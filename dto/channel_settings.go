...
type ChannelOtherSettings struct {
	...
	ResponsesWebSocketEnabled             bool                             `json:"responses_websocket_enabled,omitempty"` // 上游是否支持标准 Responses WebSocket（wss://<base>/responses）；启用后客户端 WS 请求可直通上游 WS，否则回退 HTTP
