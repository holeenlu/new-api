...
// GetGPTImage1PriceOnceCall preserves the quality/size-specific pricing used
// by the legacy image billing API while the configurable tool-price index
// handles ordinary per-call tool prices.
func GetGPTImage1PriceOnceCall(quality string, size string) float64 {
	...
	if qualityMap, ok := prices[quality]; ok {
